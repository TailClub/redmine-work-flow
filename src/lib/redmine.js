  ...
  return new Promise((resolve, reject) => {
    this._request(path, opts, function (err, res, body) {
      if (err) {
        ...
        resolve(isUpload ? JSON.parse(body) : body);
      }
    });
  });
};
 ...
 */
Redmine.prototype.issues = async function (params) {
 ...
 */
Redmine.prototype.get_issue_by_id = async function (id, params) {
  if (typeof id !== "number")
    throw new Error("Issue ID must be an integer above 0 !");

  return await this.request("GET", "/issues/" + id + ".json", params);
};
 ...
 */
Redmine.prototype.create_issue = async function (issue) {
  return await this.request("POST", "/issues.json", issue);
};
 ...
 */
Redmine.prototype.update_issue = async function (id, issue) {
  return await this.request("PUT", "/issues/" + id + ".json", issue);
};
 ...
 */
Redmine.prototype.delete_issue = async function (id) {
 ...
 */
Redmine.prototype.add_watcher = async function (id, params) {
  if (!params.user_id)
    throw new Error("user_id (required): id of the user to add as a watcher !");

  return await this.request("POST", "/issues/" + id + "/watchers.json", params);
};
 ...
 */
Redmine.prototype.remove_watcher = async function (issue_id, user_id) {
 ...
 */
Redmine.prototype.projects = async function (params) {
  return await this.request("GET", "/projects.json", params);
};
 ...
 */
Redmine.prototype.get_project_by_id = async function (id, params) {
  return await this.request("GET", "/projects/" + id + ".json", params);
};
 ...
 */
Redmine.prototype.create_project = async function (params) {
  return await this.request("POST", "/projects.json", params);
};
 ...
 */
Redmine.prototype.update_project = async function (id, params) {
  return await this.request("PUT", "/projects/" + id + ".json", params);
};
 ...
 */
Redmine.prototype.delete_project = async function (id) {
  return await this.request("DELETE", "/projects/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.users = async function (params) {
  return await this.request("GET", "/users.json", params);
};
 ...
 */
Redmine.prototype.get_user_by_id = async function (id, params) {
  return await this.request("GET", "/users/" + id + ".json", params);
};
 ...
 * http://www.redmine.org/projects/redmine/wiki/Rest_Users#GET-2
 */
Redmine.prototype.current_user = async function (params) {
  return await this.request("GET", "/users/current.json", params);
};
 ...
 */
Redmine.prototype.create_user = async function (params) {
  return await this.request("POST", "/users.json", params);
};
 ...
 */
Redmine.prototype.update_user = async function (id, params) {
  return await this.request("PUT", "/users/" + id + ".json", params);
};
 ...
 */
Redmine.prototype.delete_user = async function (id) {
  return await this.request("DELETE", "/users/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.time_entries = async function (params) {
  return await this.request("GET", "/time_entries.json", params);
};
 ...
 */
Redmine.prototype.get_time_entry_by_id = async function (id) {
  return await this.request("GET", "/time_entries/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.create_time_entry = async function (params) {
  return await this.request("POST", "/time_entries.json", params);
};
 ...
 */
Redmine.prototype.update_time_entry = async function (id, params) {
  return await this.request("PUT", "/time_entries/" + id + ".json", params);
};
 ...
 */
Redmine.prototype.delete_time_entry = async function (id) {
  return await this.request("DELETE", "/time_entries/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.membership_by_project_id = async function (id, params) {
  return await this.request(
    "GET",
 ...
 */
Redmine.prototype.create_project_membership = async function (id, params) {
  return await this.request(
    "POST",
    "/projects/" + id + "/memberships.json",
    params
 ...
 */
Redmine.prototype.project_membership_by_id = async function (id, params) {
  return await this.request("GET", "/memberships/" + id + ".json", params);
};
 ...
 */
Redmine.prototype.update_project_membership = async function (id, params) {
  return await this.request("PUT", "/memberships/" + id + ".json", params);
};
 ...
 */
Redmine.prototype.delete_project_membership = async function (id) {
  return await this.request("DELETE", "/memberships/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.issue_relation_by_issue_id = async function (id) {
  return await this.request("GET", "/issues/" + id + "/relations.json", {});
};
 ...
 */
Redmine.prototype.create_issue_relation = async function (id, params) {
  return await this.request(
    "POST",
    "/issues/" + id + "/relations.json",
    params
  );
};
 ...
 */
Redmine.prototype.issue_relation_by_id = async function (id) {
  return await this.request("GET", "/relations/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.delete_issue_relation = async function (id) {
  return await this.request("DELETE", "/relations/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.news = async function (params) {
  return await this.request("GET", "/news.json", params);
};
 ...
 */
Redmine.prototype.new_by_project_id = async function (id) {
  return await this.request("GET", "/projects/" + id + "/news.json", {});
};
 ...
 */
Redmine.prototype.version_by_project_id = async function (id, params) {
  return await this.request(
    "GET",
 ...
 */
Redmine.prototype.create_version = async function (id, params) {
  return await this.request(
    "POST",
    "/projects/" + id + "/versions.json",
    params
 ...
 */
Redmine.prototype.version_by_id = async function (id) {
  return await this.request("GET", "/versions/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.update_version = async function (id, params) {
  return await this.request("PUT", "/versions/" + id + ".json", params);
};
 ...
 */
Redmine.prototype.delete_version = async function (id) {
  return await this.request("DELETE", "/versions/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.wiki_by_project_id = async function (id) {
  return await this.request("GET", "/projects/" + id + "/wiki/index.json", {});
};
 ...
 */
Redmine.prototype.wiki_by_title = async function (id, title, params) {
  return await this.request(
    "GET",
 ...
 */
Redmine.prototype.wiki_history_by_title = async function (
  id,
  title,
  version,
  params
 ...
 */
Redmine.prototype.create_wiki = async function (id, title, params) {
  return await this.request(
    "PUT",
    "/projects/" + id + "/wiki/" + title + ".json",
    params
 ...
 */
Redmine.prototype.delete_wiki = async function (id, title) {
  return await this.request(
    "DELETE",
    "/projects/" + id + "/wiki/" + title + ".json",
    {}
 ...
 */
Redmine.prototype.queries = async function (params) {
  return await this.request("GET", "/queries.json", params);
};
 ...
 */
Redmine.prototype.attachment_by_id = async function (id) {
  return await this.request("GET", "/attachments/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.delete_attachment_by_id = async function (id) {
  return await this.request("DELETE", "/attachments/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.issue_statuses = async function (callback) {
  return await this.request("GET", "/issue_statuses.json", {});
};
 ...
 */
Redmine.prototype.trackers = async function (callback) {
  return await this.request("GET", "/trackers.json", {});
};
 ...
 */
Redmine.prototype.issue_priorities = async function (callback) {
  return await this.request("GET", "/enumerations/issue_priorities.json", {});
};
 ...
 */
Redmine.prototype.time_entry_activities = async function (callback) {
  return await this.request(
    "GET",
 ...
 */
Redmine.prototype.issue_categories_by_project_id = async function (id) {
  return await this.request(
    "GET",
    "/projects/" + id + "/issue_categories.json",
    {}
  );
};
 ...
 */
Redmine.prototype.create_issue_category = async function (id, params) {
  return await this.request(
    "POST",
    "/projects/" + id + "/issue_categories.json",
    params
 ...
 */
Redmine.prototype.issue_category_by_id = async function (id) {
  return await this.request("GET", "/issue_categories/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.update_issue_category = async function (id, params) {
  return await this.request("PUT", "/issue_categories/" + id + ".json", params);
};
 ...
 * http://www.redmine.org/projects/redmine/wiki/Rest_IssueCategories#DELETE
 */
Redmine.prototype.delete_issue_category = async function (id) {
  return await this.request("DELETE", "/issue_categories/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.roles = async function (callback) {
  return await this.request("GET", "/roles.json", {});
};
 ...
 */
Redmine.prototype.role_by_id = async function (id) {
  return await this.request("GET", "/roles/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.groups = async function (callback) {
  return await this.request("GET", "/groups.json", {});
};
 ...
 */
Redmine.prototype.create_group = async function (params) {
  return await this.request("POST", "/groups.json", params);
};
 ...
 */
Redmine.prototype.group_by_id = async function (id, params) {
  return await this.request("GET", "/groups/" + id + ".json", params);
};
 ...
 */
Redmine.prototype.update_group = async function (id, params) {
  return await this.request("PUT", "/groups/" + id + ".json", params);
};
 ...
 */
Redmine.prototype.delete_group = async function (id) {
  return await this.request("DELETE", "/groups/" + id + ".json", {});
};
 ...
 */
Redmine.prototype.add_user_to_group = async function (group_id, user_id) {
  var params = {
    user_id: user_id,
  };
  return await this.request(
 ...
 */
Redmine.prototype.remove_user_from_group = async function (group_id, user_id) {
  return await this.request(
    "DELETE",
 ...
 */
Redmine.prototype.custom_fields = async function (callback) {
  return await this.request("GET", "/custom_fields.json", {});
};

/////////////////////////////////////// REST API for Search (Alpha) ///////////////////////////////////////
// http://www.redmine.org/projects/redmine/wiki/Rest_Search
// Not documented yet.
Redmine.prototype.search = async function (q, params) {
  return await this.request("GET", "/search.json", { q, ...params });
};
...
Redmine.prototype.upload = async function (content) {
  return await this.request("POST", "/uploads.json", content);
};
